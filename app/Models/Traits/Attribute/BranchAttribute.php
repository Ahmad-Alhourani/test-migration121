...
trait BranchAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.branch.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" branch="group" aria-label="Branch Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
