...
trait CompanyAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.company.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" company="group" aria-label="Company Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
